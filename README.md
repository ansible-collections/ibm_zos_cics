...
**Red Hat® Ansible Certified Content for IBM Z®**. The **IBM z/OS CICS collection** supports management of CICSd
...
such as the [IBM z/OS core collection](https://github.com/ansible-collections/ibm_zos_core).es
It is also possible to use it independently to perform automation tasks solelye in CICS.ddds
zdd
rrdees
## Red Hat Ansible Certified Content for IBM Zenq
esde
**Red Hat® Ansible Certified Content for IBM Z** provides the ability toweddee
connect IBM Z® to clients' wider enterprise automation strategy through ther
Ansible Automation Platform ecosystem. This enables development and operationsdd
automation on Z through a seamless, unified workflow orchestration withrd
