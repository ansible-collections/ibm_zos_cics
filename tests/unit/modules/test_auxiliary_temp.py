...
def test_create_an_intial_temp_ds_with_single_volumes():
    temp_module = initialise_module(volumes="vserv1")

    assert temp_module.get_data_set()["volumes"] == ["vserv1"]
...
def test_create_an_intial_temp_ds_with_list_volumes():
    temp_module = initialise_module(volumes=["vserv1", "vserv2"])

    assert temp_module.get_data_set()["volumes"] == ["vserv1", "vserv2"]
